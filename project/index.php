...
require '../controller/c_project.php';
$bagian = "Project";
$juhal = "Project";
?>
        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                    ...
                    <div id="modalklien" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="nklien" id="nklien" placeholder="Nama klien"></input>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-primary waves-effect" id="tombol-klien" name="tombol-klien">Input Klien</button>
                    ...
                    <div id="modalproyek" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form id="formproyek">
                                    <div class="modal-body">
                                        <input type="hidden" value="proyek" id="proyek" name="proyek">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="datepicker-autoclose1" class="control-label">Tanggal</label>
                                                    <input type="text" class="form-control" id="datepicker-autoclose1" value="<?= date('m/d/Y') ?>" name="tanggal">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="field-5" class="control-label">Nama Klien</label>
                                                    <select class="form-control select2" name="kodeklien" id="kodeklien">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="outlet" placeholder="Outlet" name="outlet">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="outlet" class="control-label">Alamat Tempat</label>
                                                    <input type="text" class="form-control" id="outlet" placeholder="Tempat" name="tempat">
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select2" name="pekerjaan">
                                                        <option value="000">-- Pilih Pekerjaan --</option>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="nilaiproyek" class="control-label">Nilai Proyek</label>
                                    ...
                                    <div class="modal-footer">
                                        <button type="submit" class="btn btn-info waves-effect" id="tombol-proyek" name="tombol-proyek">Input Proyek</button>
                                        <!-- <button type="button" class="btn btn-info waves-effect waves-light">Save changes</button> -->
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="col-lg-7">
                            <div class="card-box">
                                ...
                                <div class="dropdown pull-centre">
                                    <button class="btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#input-close-modal">Total Proyek : Rp.
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card-box table-responsive">
                                <div class="dropdown pull-right">
                                    <button class="btn btn-primary waves-effect waves-light btn-xs m-b-5" data-toggle="modal" data-target="#modalklien">Input Klien</button>
                                    <button class="btn btn-info waves-effect waves-light btn-xs m-b-5" data-toggle="modal" data-target="#modalproyek">Input Proyek</button>
                                </div>
                                <h4 class="header-title m-t-0 m-b-30">Data Proyek</h4>
                                        ...
                                        <?php foreach ($proyek as $row) : ?>
                                            <tr>
                                                ...
                                                <td class="text-success">
                                                    ...
                                                    <a href="detailproyek.php?kp=<?= $row['noproyek'] ?>" target="_blank"><?php echo substr($row['noproyek'], 0, 7) ?><?php echo substr($row['noproyek'], 7, 2) ?><?php echo substr($row['noproyek'], 9, 2) ?></a>
                                                </td>
                                                ...
                                                <td>
                                                    <a href="detailproyek.php?kp=<?= $row['noproyek'] ?>" target="_blank" class="on-default edit-row badge badge-info"><i class="fa fa-pencil"></i></a> |
                                                    <input type="hidden" class="delete_id_value" value="<?= $row["id"] ?>">
                                                    <a class="on-default remove-row badge badge-danger tombol-deleteproyek"><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                            <?php $i++; ?>
                                        <?php endforeach; ?>
