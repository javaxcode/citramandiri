            ...
            <div class="sidebar-inner slimscrollleft">
                ...
                <div id="sidebar-menu">
                    <ul>
                        ...
                        <li>
                            <a href="index.html" class="waves-effect"><i class="zmdi zmdi-view-dashboard"></i> <span>
                                    Dashboard </span> </a>
                        </li>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="zmdi zmdi-chart"></i><span>
                        ...
                        <li>
                            <a href="calendar.html" class="waves-effect active"><i class="zmdi zmdi-calendar"></i><span>
                                    Calendar </span></a>
                        </li>
